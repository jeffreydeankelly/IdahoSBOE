...
/**
 * <p>Utility class that wrappers a <code>ResourceBundle</code>.  It is coupled
 * with the <code>MessageFormat</code> to make easy work out of filling in 
 * parameterized Message.</p>
 */
public class Messages {
    ...
    /**
     * <p>
     * Construct an initialized {@link Message} wrapper. At least the
    ...
    /**
     * <p>
     * Construct a new {@link Message} wrapper around the specified resource
    ...
    /**
     * <p>
     * Return the <code>Logger</code> instance for this class.
     * </p>
     */
    private Logger log() {
